<template>
  <div v-loading="revert ? loadingRevert : false">
    <div :class="imgFiles.length < 3 ? '' : 'hideUpload'">
      <div class="tip" style="margin-bottom: 5px">上传图片</div>
    ...
    <div class="tip" style="margin-top: 5px; font-size: 12px">最多上传3张，10M以内.jpg .png .gif .svg格式的图片</div>

    <div>
      <div class="tip" style="margin-bottom: 5px; margin-top: 15px">上传视频（选填，视频大小不能超过500M）</div>
...
export default {
  ...
  mounted() {
    ...
    if (this.revert) {
      ...
      console.log("thsi===", this.fileList, this.revertImg);
